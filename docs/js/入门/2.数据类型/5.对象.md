...
这时，可以使用**对象的`hasOwnProperty`方法判断一下，是否为对象自身的属性**。
...
- Angus Croll, [The Secret Life of JavaScript Primitives](https://javascriptweblog.wordpress.com/2010/09/27/the-secret-life-of-javascript-primitives/)i
